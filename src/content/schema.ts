...
import { MAX_ATTEMPTS_PER_LEVEL, MAX_TIP_BODY_LENGTH, PROMPT_CHARACTER_LIMIT, SCORE_BREAKDOWN_DIMENSIONS } from "@/lib/game";
...
export const tipRuleSchema = z.object({
  ...
  title: z.string().min(1),
  body: z.string().min(1).max(MAX_TIP_BODY_LENGTH),
