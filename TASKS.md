...
- [x] implement durable generated-asset reference persistence if resume/history requires it
- [x] enforce attempt fairness so invalid submissions and technical failures do not decrement attempts
