...
- `pnpm build`
- `rg -n "OPENAI_API_KEY|DATABASE_URL|AWS_REGION|S3_TARGET_ASSET_BUCKET|S3_GENERATED_OUTPUT_BUCKET|PIXEL_PROMPT_TARGET_ASSET_DIR|PIXEL_PROMPT_GENERATED_OUTPUT_DIR|BLOB_READ_WRITE_TOKEN" .next/static`
