...
- otherwise scope by anonymous request fingerprint derived from the trusted client IP, preferring single-hop proxy headers with a sanitized first-hop forwarded-chain fallback
